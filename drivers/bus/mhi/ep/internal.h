...
/* MHI registers */
#define MHIREGLEN				(0x100 + REG_MHIREGLEN)
#define MHIVER					(0x100 + REG_MHIVER)
#define MHICFG					(0x100 + REG_MHICFG)
#define CHDBOFF					(0x100 + REG_CHDBOFF)
#define ERDBOFF					(0x100 + REG_ERDBOFF)
#define BHIOFF					(0x100 + REG_BHIOFF)
#define BHIEOFF					(0x100 + REG_BHIEOFF)
#define DEBUGOFF				(0x100 + REG_DEBUGOFF)
#define MHICTRL					(0x100 + REG_MHICTRL)
#define MHISTATUS				(0x100 + REG_MHISTATUS)
#define CCABAP_LOWER				(0x100 + REG_CCABAP_LOWER)
#define CCABAP_HIGHER				(0x100 + REG_CCABAP_HIGHER)
#define ECABAP_LOWER				(0x100 + REG_ECABAP_LOWER)
#define ECABAP_HIGHER				(0x100 + REG_ECABAP_HIGHER)
#define CRCBAP_LOWER				(0x100 + REG_CRCBAP_LOWER)
#define CRCBAP_HIGHER				(0x100 + REG_CRCBAP_HIGHER)
#define CRDB_LOWER				(0x100 + REG_CRDB_LOWER)
#define CRDB_HIGHER				(0x100 + REG_CRDB_HIGHER)
#define MHICTRLBASE_LOWER			(0x100 + REG_MHICTRLBASE_LOWER)
#define MHICTRLBASE_HIGHER			(0x100 + REG_MHICTRLBASE_HIGHER)
#define MHICTRLLIMIT_LOWER			(0x100 + REG_MHICTRLLIMIT_LOWER)
#define MHICTRLLIMIT_HIGHER			(0x100 + REG_MHICTRLLIMIT_HIGHER)
#define MHIDATABASE_LOWER			(0x100 + REG_MHIDATABASE_LOWER)
#define MHIDATABASE_HIGHER			(0x100 + REG_MHIDATABASE_HIGHER)
#define MHIDATALIMIT_LOWER			(0x100 + REG_MHIDATALIMIT_LOWER)
#define MHIDATALIMIT_HIGHER			(0x100 + REG_MHIDATALIMIT_HIGHER)

/* MHI BHI registers */
#define BHI_IMGTXDB				(0x200 + REG_BHI_IMGTXDB)
#define BHI_EXECENV				(0x200 + REG_BHI_EXECENV)
#define BHI_INTVEC				(0x200 + REG_BHI_INTVEC)
