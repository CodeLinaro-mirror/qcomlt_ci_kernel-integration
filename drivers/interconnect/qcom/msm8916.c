...
static int msm8916_icc_aggregate(struct icc_node *node, u32 tag, u32 avg_bw,
...
static int msm8916_icc_set(struct icc_node *src, struct icc_node *dst)
{
	...
	list_for_each_entry(n, &provider->nodes, node_list)
		msm8916_icc_aggregate(n, 0, n->avg_bw, n->peak_bw,
				   &agg_avg, &agg_peak);
...
static int msm8916_qnoc_probe(struct platform_device *pdev)
{
	...
	provider->aggregate = msm8916_icc_aggregate;
