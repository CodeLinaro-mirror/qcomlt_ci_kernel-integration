...
struct mhi_ep_cntrl {
	...
	struct mhi_chan_ctx *ch_ctx_cache;
	struct mhi_event_ctx *ev_ctx_cache;
	struct mhi_cmd_ctx *cmd_ctx_cache;
	...
	struct list_head ring_transition_list;
...
int mhi_ep_set_link_state(struct mhi_ep_cntrl *mhi_cntrl, enum mhi_ep_link_state state);
