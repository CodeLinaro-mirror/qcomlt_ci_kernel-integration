...
#define Q6AFE_CDC_DMA_RX_DAI(pre, num, did) {				\
		.playback = {						\
			.stream_name = pre" CDC"#num" Playback",	\
			.rates = SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_16000 |\
				SNDRV_PCM_RATE_32000 | SNDRV_PCM_RATE_48000 |\
				SNDRV_PCM_RATE_176400,			\
			.formats = SNDRV_PCM_FMTBIT_S16_LE |		\
...
#define Q6AFE_CDC_DMA_TX_DAI(pre, num, did) {				\
		.capture = {						\
			.stream_name = pre" CDC"#num" Capture",		\
			.rates = SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_16000 |\
				SNDRV_PCM_RATE_32000 | SNDRV_PCM_RATE_48000 |\
				SNDRV_PCM_RATE_176400,			\
			.formats = SNDRV_PCM_FMTBIT_S16_LE |		\
...
static const struct snd_soc_dapm_route q6afe_dapm_routes[] = {
	...
	{"WSA_CODEC_DMA_0 Playback", NULL, "WSA_CODEC_DMA_RX_0"},
	{"WSA_CODEC_DMA_TX_0", NULL, "WSA_CODEC_DMA_0 Capture"},
	{"WSA_CODEC_DMA_1 Playback", NULL, "WSA_CODEC_DMA_RX_1"},
	{"WSA_CODEC_DMA_TX_1", NULL, "WSA_CODEC_DMA_1 Capture"},
	{"WSA_CODEC_DMA_TX_2", NULL, "WSA_CODEC_DMA_2 Capture"},
	{"VA_CODEC_DMA_TX_0", NULL, "VA_CODEC_DMA_0 Capture"},
	{"VA_CODEC_DMA_TX_1", NULL, "VA_CODEC_DMA_1 Capture"},
	{"VA_CODEC_DMA_TX_2", NULL, "VA_CODEC_DMA_2 Capture"},
	{"RX_CODEC_DMA_0 Playback", NULL, "RX_CODEC_DMA_RX_0"},
	{"TX_CODEC_DMA_TX_0", NULL, "TX_CODEC_DMA_0 Capture"},
	{"RX_CODEC_DMA_1 Playback", NULL, "RX_CODEC_DMA_RX_1"},
	{"TX_CODEC_DMA_TX_1", NULL, "TX_CODEC_DMA_1 Capture"},
	{"RX_CODEC_DMA_2 Playback", NULL, "RX_CODEC_DMA_RX_2"},
	{"TX_CODEC_DMA_TX_2", NULL, "TX_CODEC_DMA_2 Capture"},
	{"RX_CODEC_DMA_3 Playback", NULL, "RX_CODEC_DMA_RX_3"},
	{"TX_CODEC_DMA_TX_3", NULL, "TX_CODEC_DMA_3 Capture"},
	{"RX_CODEC_DMA_4 Playback", NULL, "RX_CODEC_DMA_RX_4"},
	{"TX_CODEC_DMA_TX_4", NULL, "TX_CODEC_DMA_4 Capture"},
	{"RX_CODEC_DMA_5 Playback", NULL, "RX_CODEC_DMA_RX_5"},
	{"TX_CODEC_DMA_TX_5", NULL, "TX_CODEC_DMA_5 Capture"},
	{"RX_CODEC_DMA_6 Playback", NULL, "RX_CODEC_DMA_RX_6"},
	{"RX_CODEC_DMA_7 Playback", NULL, "RX_CODEC_DMA_RX_7"},
};
...
static struct snd_soc_dai_driver q6afe_dais[] = {
	...
	Q6AFE_CDC_DMA_RX_DAI("WSA", 0, WSA_CODEC_DMA_RX_0),
	Q6AFE_CDC_DMA_TX_DAI("WSA", 0, WSA_CODEC_DMA_TX_0),
	Q6AFE_CDC_DMA_RX_DAI("WSA", 1, WSA_CODEC_DMA_RX_1),
	Q6AFE_CDC_DMA_TX_DAI("WSA", 1, WSA_CODEC_DMA_TX_1),
	Q6AFE_CDC_DMA_TX_DAI("WSA", 2, WSA_CODEC_DMA_TX_2),
	Q6AFE_CDC_DMA_TX_DAI("VA", 0, VA_CODEC_DMA_TX_0),
	Q6AFE_CDC_DMA_TX_DAI("VA", 1, VA_CODEC_DMA_TX_1),
	Q6AFE_CDC_DMA_TX_DAI("VA", 2, VA_CODEC_DMA_TX_2),
	Q6AFE_CDC_DMA_RX_DAI("RX", 0, RX_CODEC_DMA_RX_0),
	Q6AFE_CDC_DMA_TX_DAI("TX", 0, TX_CODEC_DMA_TX_0),
	Q6AFE_CDC_DMA_RX_DAI("RX", 1, RX_CODEC_DMA_RX_1),
	Q6AFE_CDC_DMA_TX_DAI("TX", 1, TX_CODEC_DMA_TX_1),
	Q6AFE_CDC_DMA_RX_DAI("RX", 2, RX_CODEC_DMA_RX_2),
	Q6AFE_CDC_DMA_TX_DAI("TX", 2, TX_CODEC_DMA_TX_2),
	Q6AFE_CDC_DMA_RX_DAI("RX", 3, RX_CODEC_DMA_RX_3),
	Q6AFE_CDC_DMA_TX_DAI("TX", 3, TX_CODEC_DMA_TX_3),
	Q6AFE_CDC_DMA_RX_DAI("RX", 4, RX_CODEC_DMA_RX_4),
	Q6AFE_CDC_DMA_TX_DAI("TX", 4, TX_CODEC_DMA_TX_4),
	Q6AFE_CDC_DMA_RX_DAI("RX", 5, RX_CODEC_DMA_RX_5),
	Q6AFE_CDC_DMA_TX_DAI("TX", 5, TX_CODEC_DMA_TX_5),
	Q6AFE_CDC_DMA_RX_DAI("RX", 6, RX_CODEC_DMA_RX_6),
	Q6AFE_CDC_DMA_RX_DAI("RX", 7, RX_CODEC_DMA_RX_7),
};
